...
class ListLocalFeatureCategoriesScreen(parent: net.minecraft.client.gui.screens.Screen? = null) : ClickGuiScreen(net.minecraft.network.chat.Component.literal("Infinite Client"), parent) {
