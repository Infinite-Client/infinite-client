...
class InfiniteBlockListField(
    x: Int,
    y: Int,
    width: Int,
    totalHeight: Int, // This is the total height of the InfiniteBlockListField widget
    private val setting: FeatureSetting.BlockListSetting,
    ...
    private val descriptionHeight = textRenderer.lineHeight + 2
